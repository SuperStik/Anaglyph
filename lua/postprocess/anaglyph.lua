...
local tex_left = GetRenderTargetEx("_rt_AnaglyphLeft", width, height, RT_SIZE_NO_CHANGE, MATERIAL_RT_DEPTH_NONE, 258, 0, IMAGE_FORMAT_BGR888)
local tex_right = GetRenderTargetEx("_rt_AnaglyphRight", width, height, RT_SIZE_NO_CHANGE, MATERIAL_RT_DEPTH_NONE, 258, 0, IMAGE_FORMAT_BGR888)
...
hook.Add("PreRender", "DrawAnaglyph", function()
	if !pp_anaglyph:GetBool() then return end
	cam.Start2D()
	surface.SetMaterial(mat_left)
	surface.SetDrawColor(255,255,255)
	surface.DrawTexturedRect(0,0,1680,1050)
	surface.SetMaterial(mat_right)
	--surface.SetDrawColor(255,255,255)
