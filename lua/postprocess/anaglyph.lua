...
local tex_left = GetRenderTargetEx("_rt_AnaglyphLeft", width, height, RT_SIZE_NO_CHANGE, MATERIAL_RT_DEPTH_SHARED, 258, 0, IMAGE_FORMAT_ABGR8888)
local tex_right = GetRenderTargetEx("_rt_AnaglyphRight", width, height, RT_SIZE_NO_CHANGE, MATERIAL_RT_DEPTH_SHARED, 258, 0, IMAGE_FORMAT_ABGR8888)
